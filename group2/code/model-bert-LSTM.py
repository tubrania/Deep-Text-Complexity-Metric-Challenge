...
#Read data
df = pd.read_excel('C:/Users/rania/Desktop/training.xlsx')
...
def build_model():
  ...
  net = tf.keras.layers.Dropout(0.1)(net[:,:,np.newaxis])
  net = tf.keras.layers.LSTM(256, dropout = 0.1)(net)
  net = tf.keras.layers.Dense(7, activation = 'relu')(net)
